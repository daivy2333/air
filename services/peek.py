...
# Add pcegen to path
pcegen_path = Path(__file__).parent.parent / "pcegen"
...
def run_peek(
    ...
    Args:
        ...
        output: Output file path (optional, if not specified, generates .pcir file with same name as PCR)

    Returns:
        Path to generated PCES file
    """
    # 加载 PCR
    ...
    if output:
        ...
        # 自动生成同名的 .pcir 文件
        output_path = pcr_file.parent / f"{pcr_file.stem}.pcir"
